...
PKG_URL=""
PKG_DEPENDS_INIT="libc:init busybox:init splash-image:init opentee_linuxdriver:init util-linux:init e2fsprogs:init dosfstools:init bkeymaps:init fakeroot:host"
